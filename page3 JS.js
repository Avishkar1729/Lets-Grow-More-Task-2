...
document.getElementById("1").addEventListener("click",function(){ ud(7); });
document.getElementById("2").addEventListener("click",function(){ ud(8); });
document.getElementById("3").addEventListener("click",function(){ ud(9); });
...
document.getElementById("7").addEventListener("click",function(){ ud(1); });
document.getElementById("8").addEventListener("click",function(){ ud(2); });
document.getElementById("9").addEventListener("click",function(){ ud(3); });
...
document.getElementById("modulus").addEventListener("click",function(){ ud('%'); });
